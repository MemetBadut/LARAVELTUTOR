<x-layout :title="$title">
    ...
    @foreach ($posts as $post)
        <article class="py-8 md:max-w-screen border-b border-gray-400">
            <a href="{{ route( $post->category) }}" class="hover:underline">
            ...
            <div>
                ...
                in
                <a href="/categories/{{ $post->category->slug }}" class="hover:underline text-base text-gray-300"> {{ $post->category->name }} </a> |
