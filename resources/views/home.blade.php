...
<body class="h-full">
    <div class="min-h-full">
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <el-dropdown class="relative ml-3">
                                <button
                                    ...
                                    <span class="absolute -inset-1.5 transition"></span>
        ...
        <header
            class="relative bg-white after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
